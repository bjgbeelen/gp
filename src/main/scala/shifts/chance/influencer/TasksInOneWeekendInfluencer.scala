...
case class TasksInOneWeekendInfluencer(weekTasks: Set[Task], desiredTasksInOneWeekend: Int, excludeNights: Boolean, assignments: Set[Task]) extends ChanceInfluencer {
