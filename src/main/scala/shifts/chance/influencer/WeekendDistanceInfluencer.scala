...
case class WeekendDistanceInfluencer(desiredDistance: Int, hard: Boolean, calendar: Calendar, taskContext: TaskContext, assignments: Set[Task]) extends ChanceInfluencer {
